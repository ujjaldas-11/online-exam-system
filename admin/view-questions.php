    ...
    <div class="container">
        ...
        <div class="header-flex">
            <div>
                ...
                <p class="subtitle">Department: <?= htmlspecialchars($subject['department']) ?> • Semester
                    <?= $subject['semester'] ?></p>
            </div>
        ...
        <?php else: ?>
            ...
            <div class="card">
                <div class="header-flex" style="margin-bottom: 10px;">
                    <h2 style="border: none; margin: 0; padding: 0;"> Question Bank (<?= count($all_results) ?> Questions)
                    </h2>
                </div>
                ...
                <div class="action-bar no-print">
                    ...
                    <form method="POST">
                        <button type="submit" name="delete_all" class="btn btn-danger" style="padding: 6px 12px;"
                            onclick="return confirm('⚠️ WARNING: Are you sure you want to delete ALL questions? This action CANNOT be undone!');">
