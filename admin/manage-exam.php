            ...
            <form method="POST">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="total_questions_to_ask" id="calcQuestions" min="1" readonly
                            style="background-color: #f1f5f9; font-weight: bold; color: var(--primary); cursor: not-allowed;">
                    </div>
