...
// Fetch all available Departments on initial load
try {
    ...
    <div class="card">
        <form method="POST">
            ...
            <div class="form-grid">
                ...
                <!-- DROPDOWN 2: Semester (Populated by JS) -->
                <div class="form-group">
            ...
            <div class="form-grid">
                <!-- DROPDOWN 3: Subject (Populated by JS) -->
                <div class="form-group">
                    <label>Subject</label>
                ...
                <!-- DROPDOWN 4: Target Unit (Populated by JS) -->
                <div class="form-group">
                    ...
                    <select name="target_units" id="unit_dropdown" required class="form-control" <?= empty($sticky_units) ? 'disabled' : '' ?>>
                        ...
                        <?php if (!empty($sticky_units)): ?>
                            <option value="all" <?= (($_POST['target_units'] ?? '') === 'all') ? 'selected' : '' ?>>All Units (Combined)</option>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Helper to reset and disable lower-level dropdowns
