        ...
        <div class=" table-wrap">
                        <table>
                            ...
                            <tbody>
                                <?php if (empty($exams)): ?>
                                    <tr>
                                        <td colspan="7" style="text-align:center; color:var(--gray);">No exams created yet
                                        </td>
                                    </tr>
                                <?php else: ?>
                                            ...
                                            <td>
                                                <div class="action-flex">
                                                    ...
                                                    <?php if ($display_status === 'NOT STARTED'): ?>
                                                        <a href="?action=start&id=<?= $exam['id'] ?>" class="btn-sm btn-start"
                                                    ...
                                                    <form method="POST" style="margin: 0;"
                                                        onsubmit="return confirm('⚠️ WARNING: Are you sure you want to permanently delete this exam?');">
                                                        <input type="hidden" name="exam_id" value="<?= $exam['id'] ?>">
                                                        <button type="submit" name="delete_exam" class="btn-sm btn-delete">🗑️
                                                            Delete</button>
                                                    </form>
                                                </div>
                                            </td>
